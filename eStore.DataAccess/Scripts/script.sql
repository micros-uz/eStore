...
go
insert into [dbo].[Authors] ([AuthorId], [Name]) values (1, 'Эспозито Д.')
go
insert into [dbo].[Authors] ([AuthorId], [Name]) values (2, 'Руссинович М.')
go
insert into [dbo].[Authors] ([AuthorId], [Name]) values (3, 'Дж. Рихтер')
go
insert into [dbo].[Authors] ([AuthorId], [Name]) values (4, 'Таненбаум Э. С.')
go
insert into [dbo].[Authors] ([AuthorId], [Name]) values (5, 'Лафоре Р.')
go
insert into [dbo].[Authors] ([AuthorId], [Name]) values (6, 'Паттерсон Д.')
go
insert into [dbo].[Authors] ([AuthorId], [Name]) values (7, 'Хейлсберг А.')
go
...
go
insert into [dbo].[Series] ([SeriesId], [Title]) values (1, 'Классика computer science')
go
insert into [dbo].[Series] ([SeriesId], [Title]) values (2, 'Мастер-класс') 
go
...
go
insert into [dbo].[Books] ([BookId], [AuthorId], [GenreId], [SeriesId],[Title], [Price], [Year], [Pages], [ISBN], [Desc])
values (1, 1, 9, 2, 'Программирование с использованием Microsoft ASP.NET 4', 1531, 2012, 880, '978-5-459-00346-8',
...
go
insert into [dbo].[Books] ([BookId], [AuthorId], [GenreId], [SeriesId],[Title], [Price], [Year], [Pages], [ISBN], [Desc])
values (2, 2, 9, 2, 'Внутреннее устройство Microsoft Windows. 6-е изд.', 1313, 2013, 800, '978-5-496-00434-3',
...
go
insert into [dbo].[Books] ([BookId], [AuthorId], [GenreId], [SeriesId],[Title], [Price], [Year], [Pages], [ISBN], [Desc])
values (3, 3, 9, 2, 'CLR via C#. Программирование на платформе Microsoft .NET Framework 4.5 на языке C#. 4-е изд.', 1238, 2013, 896, '978-5-496-00433-6',
'Четвертое издание книги, написанной признанным экспертом в области программирования Джеффри Рихтером и уже ставшей классикой, полностью обновлено в соответствии со спецификацией платформы .NET Framework 4.5, а также среды Visual Studio 2012 и C# 5.0.')
go
insert into [dbo].[Books] ([BookId], [AuthorId], [GenreId], [SeriesId],[Title], [Price], [Year], [Pages], [ISBN], [Desc])
values (4, 4, 9, 1, 'Компьютерные сети. 5-е изд.', 1238, 2012, 960, '978-5-4461-0068-2',
...
go
insert into [dbo].[Books] ([BookId], [AuthorId], [GenreId], [SeriesId],[Title], [Price], [Year], [Pages], [ISBN], [Desc])
values (5, 5, 9, 1, 'Объектно-ориентированное программирование в С++. ', 844, 2013, 928, '978-5-496-00353-7',
...
go
insert into [dbo].[Books] ([BookId], [AuthorId], [GenreId], [SeriesId],[Title], [Price], [Year], [Pages], [ISBN], [Desc])
values (6, 6, 9, 1, 'Архитектура компьютера и проектирование компьютерных систем.', 856, 2011, 784, '978-5-459-00291-1',
...
go
insert into [dbo].[Books] ([BookId], [AuthorId], [GenreId], [SeriesId],[Title], [Price], [Year], [Pages], [ISBN], [Desc])
values (7, 7, 9, 1, 'Язык программирования C#', 1188, 2011, 784, '978-5-459-00283-6',
