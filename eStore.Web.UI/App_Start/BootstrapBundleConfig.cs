...
namespace eStore.Web.UI
{
    public class BootstrapBundleConfig
    {
        public static void RegisterBundles()
        {
            ...
            BundleTable.Bundles.Add(new ScriptBundle("~/bundles/bootstrap").Include("~/Scripts/lib/bootstrap.min.js"));
            BundleTable.Bundles.Add(new StyleBundle("~/Content/bootstrap/css")
